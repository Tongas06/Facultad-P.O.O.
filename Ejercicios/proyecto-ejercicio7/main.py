...
def test():
    ...
    # Acumular millas utilizando el operador + con el entero a la izquierda
    v1 = 100 + v1
    print(v1.cantidad_total_millas())  # 6100

    # Canjear millas utilizando el operador - con el entero a la izquierda
    v1 = 100 - v1
    print(v1.cantidad_total_millas())  # 6000
